        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <p className="text-xl text-primary-foreground/90 max-w-2xl mx-auto drop-shadow">
              Find and order prescription medications, health products, and
              medical supplies from verified pharmacies near you.
            </p>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="text-center p-6 bg-gradient-card border-border/50 hover:shadow-medical transition-all duration-300"
              >
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">
              Find what you need across our comprehensive product range
            </p>
          </div>
            ...
            {categories.map((category, index) => (
              ...
              >
                <CardContent className="p-6 text-center space-y-3">
                  <div
                    className={`w-12 h-12 rounded-full ${category.color} mx-auto opacity-80 group-hover:opacity-100 transition-opacity`}
                  ></div>
          ...
          <div className="container mx-auto text-center">
            <div className="max-w-2xl mx-auto space-y-6">
              ...
              <p className="text-primary-foreground/90">
                Join thousands of satisfied customers who trust MedSupply for
                their health needs
              </p>
